...
namespace ft
{
	...
	// integral_constant
	// ex) integral_constant<int, 42>::value == 42
	...
	private:
		...
		template <typename U>
		static char is_qualified(typename ft::void_t<typename U::iterator_category>::type*,
	...
	public:
		static const bool value = sizeof(is_qualified<T>(NULL, NULL, NULL, NULL, NULL)) == 1;
	};
	...
	struct is_input_iterator
		: public integral_constant<bool,
								is_same<typename is_iterator<Iter>::category, input_iterator_tag>::value ||
								is_same<typename is_iterator<Iter>::category, forward_iterator_tag>::value ||
								is_same<typename is_iterator<Iter>::category, bidirectional_iterator_tag>::value ||
								is_same<typename is_iterator<Iter>::category, random_access_iterator_tag>::value> {};

	template <typename Iter>
	struct is_output_iterator
		: public integral_constant<bool,
								is_same<typename is_iterator<Iter>::category, output_iterator_tag>::value> {};
